...
QT_MOC_LITERAL(1, 7, 8), // "RcvPoint"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 3), // "lng"
QT_MOC_LITERAL(4, 21, 3) // "lat"

    },
    "bridge\0RcvPoint\0\0lng\0lat"
};
...
void bridge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->RcvPoint((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}
