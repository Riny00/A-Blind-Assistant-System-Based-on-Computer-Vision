...
class YoLov5TRT(object):
    ...
    def infer(self, input_image_path):
        ...
        for j in range(len(result_boxes)):
            box = result_boxes[j]
            h=box[3]-box[1]#高度
            meter=get_distance(categories[int(result_classid[j])],h)#距离
            Object=Categories[int(result_classid[j])]#中文类别
            xx=(box[2]-box[0]/2)+box[0]#方位的x坐标
            if(xx<192):
                pos='left'
                POS="左前"
            elif((xx<448)and(xx>192)):
                pos='mid'
                POS = "正前"
            else:
                pos='right'
            ...
            if(meter<1.5):
                RES_INFO = POS+"方内一点五米内有"+Object+"请注意避让"
            if (Object=="红灯"or Object=="绿灯"):
                RES_INFO = POS+"方内一点五米内有"+Object+"请注意避让"
            ...
            plot_one_box(
                ...
                image_raw,
                label="{}:{:.2f} {} {}".format(
                    categories[int(result_classid[j])], result_scores[j], meter , pos
                ),
            )
...
if __name__ == "__main__":
    ...
    Categories=['飞机','单车','小鸟','船舶','瓶子','公交','汽车','小猫','椅子','小牛',
'餐桌','小狗','小马','摩托','行人','盆栽','小羊','沙发','火车','电视','红灯','绿灯']
    ...
    try:
        ...
        while 1:
            ...
            cv2.resizeWindow("frame", 100, 350)
